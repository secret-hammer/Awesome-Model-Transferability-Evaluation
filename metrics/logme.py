...
class LogME(object):
    ...
    def _fit_icml(self, f: np.ndarray, y: np.ndarray, pca_dim):
        """
        LogME calculation proposed in the ICML 2021 paper
        "LogME: Practical Assessment of Pre-trained Models for Transfer Learning"
        at http://proceedings.mlr.press/v139/you21b.htmldd
        """
        # 如果feature的维度太高，svd可能会炸内存
    ...
    def fit(self, f: np.ndarray, y: np.ndarray, pca_dim):
        """
